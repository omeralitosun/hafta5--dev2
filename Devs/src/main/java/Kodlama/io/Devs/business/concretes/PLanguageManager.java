...
public class PLanguageManager implements PLanguageService{
	...
	public void add(ProgrammingLanguage programmingLanguage) {
		try {
			if(programmingLanguage.getName()!=null && programmingLanguage.getName().trim()!="") {
				for(ProgrammingLanguage _programmingLanguage: pLanguageRepository.findAll()) {
				...
				pLanguageRepository.save(programmingLanguage);
			}else {
	...
	public void delete(int id) {
		pLanguageRepository.deleteById(id);		
	}
	...
	public ProgrammingLanguage getById(int id) {
		// TODO Auto-generated method stub
		return pLanguageRepository.findById(id).get();
	}
